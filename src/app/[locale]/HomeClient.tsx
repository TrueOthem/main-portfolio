...
export default function HomeClient({ locale }: HomeClientProps) {
  ...
  return (
    <ClientBody>
      ...
      >
        <div className="col-span-1 md:border-r border-[#d1d1c7] flex p-0 md:p-0 lg:p-0 w-full justify-center items-center overflow-visible static top-auto right-auto bottom-auto left-auto">
          <div className="profile-image-container flex justify-center items-center w-[339px] h-[451px]">
            <Image
